...
final class IssueLink extends Section
{
    /**
     ...
     *
     * @param string $type            - link type name. Don't mess with link texts for 'in' and
     *                                'out' ends.
     ...
     *                                this issue will be shown on page with Outward Description
     *                                text
     ...
     * @param string $type           - list only links of specific type. Search is performed in
     *                               link type name AND inward/outward description text Example:
     *                               for 'Dependency' value this will return both 'blocks' and 'is
     *                               blocked by' for 'blocks' this will return only 'blocks' links
